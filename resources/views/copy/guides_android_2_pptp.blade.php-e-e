...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Android 2.3 安卓 PPTP 协议
</title>
...
<div class="row">
  ...
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>虚拟专用网名称</h3>
        <p>“虚拟专用网名称”栏中填入"云梯 VPN (PPTP)"，”确定“</p>
      </div>
    </div>
    <div>
      <img alt="虚拟专用网名称栏中填入云梯 VPN (PPTP)，确定" class="img-border loader" src="/assets/steps/android_2/pptp/step6-499a4433b6f54d4043b05a66dbe3d24b.jpg" title="虚拟专用网名称" />
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>设置成功</h3>
        <p class="height3">虚拟专用网中会看到刚设置的 "云梯 VPN (PPTP)"，点击登录</p>
      </div>
    </div>
    <div>
      <img alt="虚拟专用网中会看到刚设置的云梯 VPN (PPTP)，点击登录" class="img-border loader" src="/assets/steps/android_2/pptp/step9-d3460b58ec1a58e2a9851d7254b0fcdd.jpg" title="设置成功" />
    </div>
  </div>
</div>
