...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Windows 7 PPTP 协议
</title>
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        ...
        <p class="height3">“Internet 地址”中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“目标名称”中填入“云梯 VPN (PPTP)”；然后点击“下一步”按钮</p>
      </div>
    </div>
    <div>
      <img alt="Internet 地址中填入服务器域名（前往服务器列表页面查看）；目标名称中填入云梯 VPN (PPTP)；然后点击下一步按钮" class="img-border loader" src="/assets/steps/windows7/pptp/step7-a91f58905f5320ad31604deedf17eba8.jpg" title="Internet 地址，目标名称" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>快速连接，断开</h3>
        <p class="height4">点击电脑屏幕右下角的网络标志，看到“云梯 VPN (PPTP)”的连接状态，通过“断开”或“连接”按钮，方便快速断开或连接 VPN</p>
      </div>
    </div>
    <div>
      <img alt="点击电脑屏幕右下角的网络标志，看到云梯 VPN (PPTP)的连接状态，通过断开或连接按钮，方便快速断开或连接 VPN" class="img-border loader" src="/assets/steps/windows7/pptp/step11-75003dd50f320b3a9f323076bed22966.jpg" title="快速连接，断开" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
...
data-url='https://www.yuntiprivaten.com/guides/windows7_pptp' data-desc='' data-popup='true' data-via=''>
