...
<div class="row">
  <div class="col-md-12">
    <h5><strong>感谢选择云梯 VPN，请在使用过程中，遵守本服务条款，感谢支持！</strong></h5>
    <p>
      云梯不允许使用我们的服务进行任何形式的非法行为，如发送垃圾邮件、黑客攻击等。<br>
      如果进行以下禁止的行为，云梯有权在不发出警告的情况下，取消该帐号的服务并且不退款。
    </p>
    <ol>
      <li>连着云梯时，使用 BT，eMule，迅雷，FlashGet，Tor 等 P2P 工具</li>
      <li>发送垃圾邮件</li>
      <li>在论坛或留言板发送垃圾信息</li>
      <li>多人长期合用同个帐号（企业版套餐除外）</li>
      <li>干扰或破坏云梯的服务（或者与服务相关的服务器及网络）</li>
      <li>探测、扫描或测试本系统或任何与本系统相连的网络的漏洞，破坏安全或认证措施</li>
      <li>利用本系统可能存在的技术缺陷或漏洞以各种形式为自己及他人牟利</li>
      <li>出于任何目的，仿造、复制、出售或者转售云梯的服务</li>
      <li>侵犯知识产权</li>
