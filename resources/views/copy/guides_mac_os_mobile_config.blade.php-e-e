...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Mac OS X 一键安装
</title>
...
<div class="row">
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>安装成功</h3>
        <p>安装成功，在“系统偏好设置”中可以找到“云梯 VPN 配置”的描述文件；然后点击“全部显示”按钮，回到“系统偏好设置”</p>
      </div>
    </div>
    <div>
      <img alt="安装成功，在“系统偏好设置”中可以找到“云梯 VPN 配置”的描述文件；然后点击“全部显示”按钮，回到“系统偏好设置”" class="img-border loader" src="/assets/steps/mac_os/mobile_config/step4-3a4e58c56abbb107ffd77423863f5a6d.jpg" title="安装成功" />
    </div>
  </div>
</div>
...
data-url='https://www.yuntiprivaten.com/guides/mac_os_mobile_config' data-desc='' data-popup='true' data-via=''>
