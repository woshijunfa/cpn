  ...
  <div class="col-md-9">
    ...
    <div id="Q1" class="panel panel-basic">
      ...
      <div class="panel-body">
        ...
        1. 检查以下内容是否填写正确：用户名（<span class="label label-danger">不是</span>邮箱），密码，服务器域名；<a href="/admin" target="_blank">前往我的云梯首页</a>，在侧边栏下方可以查看你的帐号信息。<br>
        2. 尝试分别用 PPTP 和 L2TP/IPSec 两种协议进行连接。<br>
        3. 尝试连接多台不同的服务器。<br>
        4. 设置 L2TP/IPsec 协议的 VPN 时，正确填写密钥，注意区分大小写；<a href="/admin" target="_blank">前往我的云梯首页</a>，在侧边栏下方可以点击查看密钥。<br>
        5. 在本地网络下 ping 各台服务器域名，查看延时和丢包率，判断你的网络到云梯服务器是否畅通。<br>
        如果以上方法都无法解决问题，请 <a href="/admin/tickets" target="_blank">提交服务单</a> 说明具体的情况，云梯MM一定会尽快回复的。
      </div>
    ...
    <div id="Q3" class="panel panel-basic">
      ...
      <div class="panel-body">
        这通常是本地网络到云梯服务器之间，有丢包率较高的网关导致的。部分小运营商还会动态切换国际出口，导致原来的链路断开。<br>
    ...
    <div id="Q4" class="panel panel-basic">
      ...
      <div class="panel-body">
        云梯所有服务器的带宽都在50M~250M，速度都很快，所以实际连接速度取决于你的网络运营商分配给你的国际出口带宽。<br>
    ...
    <div id="Q5" class="panel panel-basic">
      ...
      <div class="panel-body">
        ...
        根据云梯使用长城宽带的用户反映，该网络下连接 VPN 问题比较多（包括无法连接 VPN，连接后速度非常慢，ping 服务器丢包100%等）。<br>
...
data-url='/faq/link' data-desc='' data-popup='true' data-via=''>
