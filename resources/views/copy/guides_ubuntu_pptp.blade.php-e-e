...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Ubuntu Linux PPTP 协议
</title>
...
<div class="row">
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>填写 VPN 帐号信息</h3>
        <p class="height5">"Connection name"栏中填入“云梯 VPN (PPTP)”；"Gateway"中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；"User name"中填入你的VPN帐号用户名；"Password"中填入你的VPN帐号密码；最后点击"Advanced..."按钮</p>
      </div>
    </div>
    <div>
      <img alt="Connection name栏中填入云梯 VPN (PPTP)；Gateway中填入服务器域名（前往服务器列表页面查看）；User name中填入你的VPN帐号用户名；Password中填入你的VPN帐号密码；最后点击Advanced...按钮" class="img-border loader" src="/assets/steps/ubuntu/pptp/step4-3aa1ecba3a84da6fd178c620aaf5dcea.jpg" title="填写 VPN 帐号信息" />
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>连接 VPN</h3>
        <p>点击 "VPN Connections" 下的“云梯 VPN (PPTP)”，开始连接 VPN</p>
      </div>
    </div>
    <div>
      <img alt="点击VPN Connections下的云梯 VPN (PPTP)，开始连接 VPN" class="img-border loader" src="/assets/steps/ubuntu/pptp/step7-c8089b14436ab2fc229302d1e2ea5a2f.jpg" title="连接 VPN" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
