...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Android 2.3 安卓 L2TP 协议
</title>
...
<div class="row">
  ...
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>虚拟专用网名称</h3>
        <p class="height3">“虚拟专用网名称”栏中填入"云梯 VPN (L2TP)"，点击”确定“</p>
      </div>
    </div>
    <div>
      <img alt="虚拟专用网名称栏中填入云梯 VPN (L2TP)，点击确定" class="img-border loader" src="/assets/steps/android_2/l2tp/step5-8f6ae1f6dd7f81b918e91e060ceec34b.jpg" title="虚拟专用网名称" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
...
<div class="row">
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>共享密钥</h3>
        <p class="height3">“设置 IPSec 预共享密钥” 中填入具体密钥（<a href="/admin" target="_blank">前往我的云梯首页查看共享密钥</a>），确定</p>
      </div>
    </div>
    <div>
      <img alt="“设置 IPSec 预共享密钥” 中填入具体密钥（前往我的云梯首页查看共享密钥），确定" class="img-border loader" src="/assets/steps/android_2/l2tp/step7-4d8e445e66351c370e88df313d6ec2ca.jpg" title="共享密钥" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
  ...
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>设置成功</h3>
        <p class="height3">虚拟专用网中会看到刚设置的 "云梯 VPN (L2TP)"，点击登录</p>
      </div>
    </div>
    <div>
      <img alt="虚拟专用网中会看到刚设置的云梯 VPN (L2TP)，点击登录" class="img-border loader" src="/assets/steps/android_2/l2tp/step9-1193b5b42cb0ca7994056f5152ece1c4.jpg" title="设置成功" />
    </div>
  </div>
</div>
