...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Windows 8 L2TP 协议
</title>
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        ...
        <p class="height3">“Internet 地址”中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“目标名称”中填入“云梯 VPN (L2TP)”；然后点击“创建”按钮</p>
      </div>
    </div>
    <div>
      <img alt="Internet 地址中填入服务器域名（前往服务器列表页面查看）；目标名称中填入云梯 VPN (L2TP)；然后点击创建按钮" class="img-border loader" src="/assets/steps/windows8/l2tp/step7-07a835c3ca74d731417926dfa7bc4ccd.jpg" title="Internet 地址，目标名称" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>更改适配器设置</h3>
        <p class="height3">点击“网络和共享中心”左侧的“更改适配器设置”文字，找到刚创建的“云梯 VPN (L2TP)”</p>
      </div>
    </div>
    <div>
      <img alt="点击“网络和共享中心”左侧的“更改适配器设置”文字，找到刚创建的云梯 VPN (L2TP)" class="img-border loader" src="/assets/steps/windows8/l2tp/step8-f2b7792fd912f2af2054bac9f51aa832.jpg" title="更改适配器设置" />
    </div>
  </div>
</div>  
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>属性</h3>
        <p>右键点击“云梯 VPN (L2TP)”，然后点击“属性”</p>
      </div>
    </div>
    <div>
      <img alt="右键点击云梯 VPN (L2TP)，然后点击“属性”" class="img-border loader" src="/assets/steps/windows8/l2tp/step9-d51f7c18978175f69513d9bb331f335c.jpg" title="属性" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
...
<div class="row">
  ...
  <div class="col-md-6 step">
    ...
    <div>
      <img alt="“密钥”中填入具体密钥（前往我的云梯首页查看共享密钥）；然后点击”确定“按钮" class="img-border loader" src="/assets/steps/windows8/l2tp/step12-de880806a769fb160def55d6757ffc07.jpg" title="密钥" />
    </div>
  </div>
</div> 
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>连接/断开</h3>
        <p>右键点击“云梯 VPN (L2TP)”，然后点击“连接/断开”</p>
      </div>
    </div>
    <div>
      <img alt="右键点击云梯 VPN (L2TP)，然后点击“连接/断开”" class="img-border loader" src="/assets/steps/windows8/l2tp/step13-3d67a798469d655f102a63f5c9f53839.jpg" title="连接/断开" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>连接</h3>
        <p>点击 Charm 栏中刚创建的“云梯 VPN (L2TP)”，然后点击“连接”按钮</p>
      </div>
    </div>
    <div>
      <img alt="点击 Charm 栏中刚创建的云梯 VPN (L2TP)，然后点击“连接”按钮" class="img-border loader" src="/assets/steps/windows8/l2tp/step14-a8e6b03e82ab66e55c90fd95d1198ccb.jpg" title="连接" />
    </div>
  </div>
</div> 
...
data-url='https://www.yuntiprivaten.com/guides/windows8_l2tp' data-desc='' data-popup='true' data-via=''>
