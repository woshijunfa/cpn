...
<meta content="ZXluZyTKK4SZJV3TyJabpdG9DQg0YfxKisjB+QYs4Rs=" name="csrf-token" />
  <!--[if lt IE 9]>
...
<div class="form-container-md">
  <form accept-charset="UTF-8" action="/users" class="simple_form form-horizontal" id="new_user" method="post" novalidate="novalidate"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ZXluZyTKK4SZJV3TyJabpdG9DQg0YfxKisjB+QYs4Rs=" /></div>
    

    <div class="form-group email required user_email"><label class="email required col-sm-2 control-label" for="user_email"><abbr title="必填">*</abbr> 邮箱</label><div class="col-sm-10"><input autocapitalize="none" autocomplete="off" autocorrect="off" autofocus="autofocus" class="string email required form-control typeahead typeahead-email form-control" id="user_email" name="user[email]" size="50" type="email" value="" /><p class="help-block">请填写常用的邮箱，便于接收服务器信息等重要通知，方便你长期使用<br>QQ 和 Foxmail 邮箱可能会收不到</p></div></div>
    ...
    <div class="form-group password required user_password"><label class="password required col-sm-2 control-label" for="user_password"><abbr title="必填">*</abbr> 密码</label><div class="col-sm-10"><input autocapitalize="none" autocomplete="off" autocorrect="off" class="password required form-control" id="user_password" name="user[password]" size="50" type="password" /></div></div>
    <div class="form-group password required user_password_confirmation"><label class="password required col-sm-2 control-label" for="user_password_confirmation"><abbr title="必填">*</abbr> 确认密码</label><div class="col-sm-10"><input autocapitalize="none" autocomplete="off" autocorrect="off" class="password required form-control" id="user_password_confirmation" name="user[password_confirmation]" size="50" type="password" /></div></div>
    <input id="user_refcode" name="user[refcode]" type="hidden" />

    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <p class="form-control-static">我已阅读并同意云梯的<a href="/terms_of_service" target="_blank">《服务条款》</a></p>
      </div>
    </div>

    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <input class="btn btn btn-primary" name="commit" type="submit" value="注册" />
