...
<div class="form-container-md">
  <form accept-charset="UTF-8" action="/users/sign_in" class="simple_form form-horizontal" id="new_user" method="post" novalidate="novalidate"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="JqVZ5sbDPuPQ4V2MGRFOrGPEStaklvgZQtc2bCsI0Bw=" /></div>
    <div class="form-group string optional user_login"><label class="string optional col-sm-2 control-label" for="user_login">帐号</label><div class="col-sm-10"><input autocapitalize="none" autocomplete="off" autocorrect="off" autofocus="autofocus" class="string optional form-control" id="user_login" name="user[login]" placeholder="邮箱或用户名" size="50" type="text" /></div></div>
    <div class="form-group password optional user_password"><label class="password optional col-sm-2 control-label" for="user_password">密码</label><div class="col-sm-10"><input autocapitalize="none" autocomplete="off" autocorrect="off" class="password optional form-control" id="user_password" name="user[password]" size="50" type="password" /></div></div>
...
data-url='/users/sign_in' data-desc='' data-popup='true' data-via=''>
