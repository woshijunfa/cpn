...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Windows XP PPTP 协议
</title>
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>公司名</h3>
        <p>“公司名”中填入“云梯 VPN (PPTP)”；然后点击“下一步”按钮</p>
      </div>
    </div>
    <div>
      <img alt="公司名中填入云梯 VPN (PPTP)；然后点击下一步按钮" class="img-border loader" src="/assets/steps/windows_xp/pptp/step5-e909565d40a3b8817c99b1d6725e6c24.jpg" title="公司名" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>双击连接</h3>
        <p>在“虚拟专用网络”里看到之前新建的“云梯 VPN (PPTP)”，双击图标，打开连接窗口</p>
      </div>
    </div>
    <div>
      <img alt="在虚拟专用网络里看到之前新建的云梯 VPN (PPTP)，双击图标，打开连接窗口" class="img-border loader" src="/assets/steps/windows_xp/pptp/step9-b9b7a3a78c1654860b6ed0d8a2bfe70f.jpg" title="双击连接" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
...
<div class="row">
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>快速连接，断开</h3>
        <p class="height3">右键点击 VPN 桌面快捷方式，看到“云梯 VPN (PPTP)”的连接状态，通过“断开”或“连接”按钮，方便快速断开或连接 VPN</p>
      </div>
    </div>
    <div>
      <img alt="右键点击 VPN 桌面快捷方式，看到云梯 VPN (PPTP)的连接状态，通过断开或连接按钮，方便快速断开或连接 VPN" class="img-border loader" src="/assets/steps/windows_xp/pptp/step12-e27c5a964692b89a73b2c050421c1788.jpg" title="快速连接，断开" />
    </div>
  </div>
</div>
