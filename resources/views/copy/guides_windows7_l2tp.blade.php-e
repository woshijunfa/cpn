...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Windows 7 L2TP 协议
</title>
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        ...
        <p class="height3">“Internet 地址”中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“目标名称”中填入“云梯 VPN (L2TP)”；然后点击“下一步”按钮</p>
      </div>
    </div>
    <div>
      <img alt="Internet 地址中填入服务器域名（前往服务器列表页面查看）；目标名称中填入云梯 VPN (L2TP)；然后点击下一步按钮" class="img-border loader" src="/assets/steps/windows7/l2tp/step7-4e3895ec968bc73b58f6548597f7991b.jpg" title="Internet 地址，目标名称" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
...
<div class="row">
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>网络，连接</h3>
        <p>点击电脑屏幕右下角的网络标志，看到之前新建的“云梯 VPN (L2TP)”，点击“连接”按钮</p>
      </div>
    </div>
    <div>
      <img alt="点击电脑屏幕右下角的网络标志，看到之前新建的云梯 VPN (L2TP)，点击连接按钮" class="img-border loader" src="/assets/steps/windows7/l2tp/step10-d5bcb1b1a1eb9900f5852b1a858835fe.jpg" title="网络，连接" />
    </div>
  </div>
</div> 
...
<div class="row">
  ...
  <div class="col-md-6 step">
    ...
    <div>
      <img alt="“密钥”中填入具体密钥（前往我的云梯首页查看共享密钥）；然后点击”确定“按钮" class="img-border loader" src="/assets/steps/windows7/l2tp/step14-f2fee08b5b6b6f78d04ea799443040d1.jpg" title="密钥" />
    </div>
  </div>
</div> 
...
<div class="row">
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>快速连接，断开</h3>
        <p class="height3">点击电脑屏幕右下角的网络标志，看到“云梯 VPN (L2TP)”的连接状态，通过“断开”或“连接”按钮，方便快速断开或连接 VPN</p>
      </div>
    </div>
    <div>
      <img alt="点击电脑屏幕右下角的网络标志，看到云梯 VPN (L2TP)的连接状态，通过断开或连接按钮，方便快速断开或连接 VPN" class="img-border loader" src="/assets/steps/windows7/l2tp/step16-d94f3709dde8d01ef6b4a6e85d688488.jpg" title="快速连接，断开" />
    </div>
  </div>
</div> 
...
data-url='https://www.yuntiprivaten.com/guides/windows7_l2tp' data-desc='' data-popup='true' data-via=''>
