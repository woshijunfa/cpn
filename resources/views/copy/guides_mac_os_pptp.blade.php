...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Mac OS X PPTP 协议
</title>
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        ...
        <p class="height3">“接口”栏中选择“ VPN ”，选择后，下面的选项随之变化；“VPN 类型”栏中选择“ PPTP ”；”服务名称“中填入”云梯 VPN (PPTP)“；最后点击”创建“按钮</p>
      </div>
    </div>
    <div>
      <img alt="接口栏中选择VPN，选择后，下面的选项随之变化；VPN 类型栏中选择PPTP；服务名称中填入云梯 VPN (PPTP)；最后点击创建按钮" class="img-border loader" src="/assets/steps/mac_os/pptp/step4-a712a19eba379d51647e9dd27390d6eb.jpg" title="接口，VPN 类型，服务名称" />
    </div>
  </div>
</div>
...
data-url='https://www.yuntiprivaten.com/guides/mac_os_pptp' data-desc='' data-popup='true' data-via=''>
