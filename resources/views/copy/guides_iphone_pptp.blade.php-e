...
<head>
  ...
  <title>云梯 VPN -   使用教程 - iPhone PPTP 协议
</title>
...
<div class="row">
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>VPN 配置信息</h3>
        <p class="height7">协议类型选择“ PPTP ”；“描述”栏中填入“云梯 VPN (PPTP)”；“服务器”栏中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“帐户”栏中填入你的VPN用户名；“密码”栏中填入填入你的VPN密码；然后点右上角的"存储"按钮</p>
      </div>
    </div>
    <div>
      <img alt="协议类型选择PPTP；描述栏中填入云梯 VPN (PPTP)；服务器栏中填入服务器域名（前往服务器列表页面查看）；帐户栏中填入你的VPN用户名；密码栏中填入填入你的VPN密码；然后点右上角的存储按钮" class="img-border loader-lg" src="/assets/steps/iphone/pptp/step4-ab0d5dc424e437f79044caed6aa65507.jpg" title="VPN 配置信息" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>连接</h3>
        <p class="height7">VPN 配置中会看到刚设置的"云梯 VPN (PPTP)"，选中后打开上方的 VPN 连接，状态改变为已连接</p>
      </div>
    </div>
    <div>
      <img alt="VPN 配置中会看到刚设置的云梯 VPN (PPTP)，选中后打开上方的 VPN 连接，状态改变为已连接" class="img-border loader-lg" src="/assets/steps/iphone/pptp/step5-42b267471a259bb2f070a8835426f98d.jpg" title="连接" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
...
data-url='https://www.yuntiprivaten.com/guides/iphone_pptp' data-desc='' data-popup='true' data-via=''>
