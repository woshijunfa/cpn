...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Windows 8 PPTP 协议
</title>
  ...
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        ...
        <p class="height3">“Internet 地址”中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“目标名称”中填入“云梯 VPN (PPTP)”；然后点击“创建”按钮</p>
      </div>
    </div>
    <div>
      <img alt="Internet 地址中填入服务器域名（前往服务器列表页面查看）；目标名称中填入云梯 VPN (PPTP)；然后点击创建按钮" class="img-border loader" src="/assets/steps/windows8/pptp/step7-87853422fdb3bbf721cdf3b60b77e3bd.jpg" title="Internet 地址，目标名称" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>连接</h3>
        <p class="height3">点击 Charm 栏中刚创建的“云梯 VPN (PPTP)”，然后点击“连接”按钮</p>
      </div>
    </div>
    <div >
      <img alt="点击 Charm 栏中刚创建的云梯 VPN (PPTP)，然后点击“连接”按钮" class="img-border loader" src="/assets/steps/windows8/pptp/step8-82d740aaadd3742695dacca389cec4d9.jpg" title="连接" />
    </div>
  </div>
</div>
...
data-url='https://www.yuntiprivaten.com/guides/windows8_pptp' data-desc='' data-popup='true' data-via=''>
