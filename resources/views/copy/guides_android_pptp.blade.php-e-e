...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Android 安卓 PPTP 协议
</title>
...
<div class="row">
  ...
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>添加 PPTP VPN</h3>
        <p class="height6">点击顶部"+"，“名称”栏中填入"云梯 VPN (PPTP)"；“类型”选择"PPTP"；“服务器地址”栏中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；勾选“PPP 加密(MPPE)”；点击“保存”按钮</p>
      </div>
    </div>
    <div>
      <img alt="点击顶部+，名称栏中填入云梯 VPN (PPTP)；类型选择PPTP；服务器地址栏中填入服务器域名（前往服务器列表页面查看）；勾选PPP 加密(MPPE)；点击保存按钮" class="img-border loader" src="/assets/steps/android/pptp/step3-47f2631ab0003a46dd93bc89e214fea7.jpg" title="添加 PPTP VPN" />
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>设置成功</h3>
        <p class="height3">VPN 列表中会看到刚设置的 "云梯 VPN (PPTP)"，点击登录</p>
      </div>
    </div>
    <div>
      <img alt="VPN 列表中会看到刚设置的云梯 VPN (PPTP)，点击登录" class="img-border loader" src="/assets/steps/android/pptp/step4-5aca626b8447b20c49310b01c8ae7d5c.jpg" title="设置成功" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
