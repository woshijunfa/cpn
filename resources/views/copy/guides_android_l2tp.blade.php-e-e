...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Android 安卓 L2TP 协议
</title>
...
<div class="row">
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>编辑 L2TP VPN</h3>
        <p class="height7">“名称”栏中填入"云梯 VPN (L2TP)"；“类型”选择"L2TP/IPSec PSK"；“服务器地址”栏中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“IPSec 预共享密钥” 中填入具体密钥（<a href="/admin" target="_blank">前往我的云梯首页查看共享密钥</a>）；点击“保存”按钮</p>
      </div>
    </div>
    <div>
      <img alt="名称栏中填入云梯 VPN (L2TP)；类型选择L2TP/IPSec PSK；服务器地址栏中填入服务器域名（前往服务器列表页面查看）；IPSec 预共享密钥中填入具体密钥（前往我的云梯首页查看共享密钥）；点击保存按钮" class="img-border loader" src="/assets/steps/android/l2tp/step4-1f4f43497dff5d6abcd00b23fe740252.jpg" title="编辑 L2TP VPN" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
      ...
      <div class="col-md-9 step-content">
        <h3>设置成功</h3>
        <p class="height7">VPN 列表中会看到刚设置的 "云梯 VPN (L2TP)"，点击登录</p>
      </div>
    </div>
    <div>
      <img alt="VPN 列表中会看到刚设置的云梯 VPN (L2TP)，点击登录" class="img-border loader" src="/assets/steps/android/l2tp/step5-6c52e0ed49ff37d752d06600681a391b.jpg" title="设置成功" />
    </div>
  </div>
  <div class="col-md-4 step">
    <div class="row">
...
data-url='https://www.yuntiprivaten.com/guides/android_l2tp' data-desc='' data-popup='true' data-via=''>
