...
<head>
  ...
  <title>云梯 VPN -   使用教程 - Ubuntu Linux L2TP 协议
</title>
...
<div class="row">
  <div class="col-md-6 step">
    <div class="row">
      ...
      <div class="col-md-10 step-content">
        <h3>填写 VPN 服务器和域名</h3>
        <p class="height4">IPsec 标签下，"Remote Server"中填入服务器域名（<a href="/admin/servers" target="_blank">前往服务器列表页面查看</a>）；“Use pre-shared key for authentication”中填入具体密钥（<a href="/admin" target="_blank">前往我的云梯首页查看共享密钥</a>）</p>
      </div>
    </div>
    <div>
      <img alt="IPsec 标签下，&quot;Remote Server&quot;中填入服务器域名（前往服务器列表页面查看）；“Use pre-shared key for authentication”中填入具体密钥（前往我的云梯首页查看共享密钥）" class="img-border loader" src="/assets/steps/ubuntu/l2tp/step5-16f003add839a9ded25add49bc12685f.jpg" title="填写 VPN 服务器和域名" />
    </div>
  </div>
  <div class="col-md-6 step">
    <div class="row">
