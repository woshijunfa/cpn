...
<div class="form-container-small">
  <form accept-charset="UTF-8" action="/admin/user/update_email" class="simple_form form-horizontal" id="edit_user" method="post" novalidate="novalidate"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NeaRyjJM41mLMZch87q3glbNbqEcctietz+l75jMJ8k=" /></div>
    <div class="form-inputs">
      ...
      <div class="form-group password optional user_current_password"><label class="password optional col-sm-2 control-label" for="user_current_password">云梯密码</label><div class="col-sm-10"><input class="password optional form-control" id="user_current_password" name="user[current_password]" size="50" type="password" /><p class="help-block">需要验证你的云梯密码，防止邮箱被误改</p></div></div>
    </div>
    <div class="form-group">
