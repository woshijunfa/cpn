...
<p>云梯新增服务器线路，或你修改了密码后，重新下载最新配置文件即可。</p>
...
<div class="form-container-small">
  <form accept-charset="UTF-8" action="/admin/mobile_configs" class="form-horizontal" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9Z30SK8a/sZ5dl5tG9yR5iOyBijXAWkLX0RktRGP6zw=" /></div>
    <div class="form-group password">
      <label class="col-sm-2 control-label" for="password">云梯密码</label>
      <div class="col-sm-10">
        <input class="password form-control" id="password" name="password" type="password" />
        <p class="help-block">配置文件中自动填写你的云梯密码</p>
      </div>
    </div>
...
<p>移除系统设置中“云梯 VPN 配置”这个描述文件即可。</p>
