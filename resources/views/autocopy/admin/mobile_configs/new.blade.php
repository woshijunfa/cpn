...
<meta content="9Z30SK8a/sZ5dl5tG9yR5iOyBijXAWkLX0RktRGP6zw=" name="csrf-token" />
</head>
<body>
  <div id="wrapper">
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="alert alert-danger">
          <h4>你的服务已到期</h4>
          <p>现在续费，依然享受原价。无需重新设置，就能继续使用。几天后，就只能购买新价格的套餐了。</p>
          <p>
            <a href="/admin/orders/renew?service_id=51237573" class="btn btn-success">现在原价续费</a>
          </p>
        </div>
...
<p>目前支持 iPhone, iPad, Mac 等设备，用相应设备打开本页面完成安装。</p>
<p>无需卸载老的配置文件，直接安装即可更新为最新设置。</p>
<p>天梯新增服务器线路，或你修改了密码后，重新下载最新配置文件即可。</p>

<div class="form-container-small">
  <form accept-charset="UTF-8" action="/admin/mobile_configs" class="form-horizontal" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9Z30SK8a/sZ5dl5tG9yR5iOyBijXAWkLX0RktRGP6zw=" /></div>
    <div class="form-group password">
      <label class="col-sm-2 control-label" for="password">天梯密码</label>
      <div class="col-sm-10">
        <input class="password form-control" id="password" name="password" type="password" />
        <p class="help-block">配置文件中自动填写你的天梯密码</p>
      </div>
    </div>

    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <input class="btn btn-primary" data-disable-with="正在提交..." name="commit" type="submit" value="确认" />
      </div>
    </div>
</form></div>
...
<div class="nav-container">
  <ul class="nav nav-pills nav-justified">
    <li class="active">
      <a href="/admin/mobile_configs/new?platform=iphone">iPhone</a>
    </li>
    <li class="">
      <a href="/admin/mobile_configs/new?platform=ipad">iPad</a>
    </li>
    <li class="">
      <a href="/admin/mobile_configs/new?platform=osx">Mac OS X</a>
    </li>
  </ul>
</div>
...
<div class="row">
  <div class="col-md-4">
    <img alt="下载后，点击安装按钮" class="center-block" src="/assets/admin/iphone_mobile_config/step1-6e6e263c87810dd6dd7c8ead4a42bec1.jpg" />
  </div>    
  <div class="col-md-4">
    <img alt="安装完成后，点击完成按钮" class="center-block" src="/assets/admin/iphone_mobile_config/step2-afa4f088772aadc9f943f7d7d9980036.jpg" />
  </div>    
  <div class="col-md-4">
    <img alt="在设置中的 VPN 下，选择并连接 VPN" class="center-block" src="/assets/admin/iphone_mobile_config/step3-0d89c04d5babeb13fd59ce43d65c21ee.jpg" />
  </div>
  <div class="col-md-12">
    <p class="alert alert-blank">更多步骤请查看 <a href="/guides/iphone_mobile_config" target="_blank">详细安装教程</a></p>
  </div>  
</div>
...
<p>移除系统设置中“天梯 VPN 配置”这个描述文件即可。</p>
